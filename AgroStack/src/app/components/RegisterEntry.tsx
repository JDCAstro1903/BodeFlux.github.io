import { X, Package, Calendar, MapPin, Building2, Hash, Weight } from 'lucide-react';
              ...
              <div className="md:col-span-2">
                ...
                <div className="p-4 rounded-[20px] bg-gradient-to-br from-[#F3F4F6] to-[#E5E7EB] dark:from-[#2C2C2E] dark:to-[#1C1C1E] border border-gray-200 dark:border-[#3A3A3C]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {/* TODO: populate from backend providers list */}
                    {([] as { name: string; category: string; rating: number }[]).map((provider) => {
