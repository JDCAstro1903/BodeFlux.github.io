    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1B4332] via-[#2D6A4F] to-[#40916C]">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-white/90 backdrop-blur-xl mb-4 animate-pulse overflow-hidden">
            <img src={logoImg} alt="BodeFlux" className="w-16 h-16 object-contain" />
          </div>
          <p className="text-white/80 text-lg font-medium">Cargando BodeFlux...</p>
        </div>
      </div>
    );
  }
